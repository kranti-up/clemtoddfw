...
CONFIG = {
    "openai_api_key": os.environ.get("OPENAI_API_KEY", "your-default-key"), #Put your own there
    "openai_organization": os.environ.get("OPENAI_API_ORG", "your-default-org"), #Put your own there (needed afaik if using gpt4)
